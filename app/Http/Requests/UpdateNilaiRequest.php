...
class UpdateNilaiRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user()?->can('update', $nilai) ?? false;
    }
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $v): void {
            ...
            $dup = Nilai::query()
                ...
                ->whereKeyNot($nilai->id)
                ->exists();
            if ($dup) {
                $v->errors()->add('siswa_id', __('Nilai untuk kombinasi siswa, mapel, semester, dan tahun ajaran ini sudah digunakan baris lain.'));
            }
        });
    }
}
