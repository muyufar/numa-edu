...
<body class="min-h-screen bg-gray-100 font-sans text-gray-900 antialiased">
    <div class="mx-auto max-w-md p-6">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-lg ring-1 ring-black/5">
            ...
            <div class="mt-6 flex justify-center">
                <canvas id="presensi-kartu-qr" width="220" height="220" class="rounded-xl ring-1 ring-gray-200"></canvas>
            </div>
    ...
    <script>
        const kode = @json($record->presensi_kode);
        const canvas = document.getElementById('presensi-kartu-qr');
        QRCode.toCanvas(canvas, kode, { width: 220, margin: 1 });
    </script>
</body>
</html>
