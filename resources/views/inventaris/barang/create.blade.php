<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="text-xl font-bold leading-tight text-nu-primary">{{ __('Inventaris · Tambah Barang') }}</h2>
            <p class="mt-1 text-sm text-gray-600">{{ __('Buat master barang inventaris.') }}</p>
        </div>
    </x-slot>
