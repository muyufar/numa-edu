<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <h2 class="text-xl font-bold leading-tight text-nu-primary">{{ __('Edit guru') }}</h2>
                <p class="mt-1 text-sm text-gray-600">{{ __('Perbarui data guru dan email masuk.') }}</p>
            </div>
